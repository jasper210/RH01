...
CFLAGS += -fdiagnostics-color=always -Wall -Wpointer-arith -Wundef -Wno-write-strings 
...
all: LIBFLAGS += -Wl,--start-group -L../../../component/soc/realtek/8710c/misc/bsp/lib/common/GCC -l_soc_ns -l_wlan_ns -Wl,--end-group
mp: LIBFLAGS += -Wl,--start-group -L../../../component/soc/realtek/8710c/misc/bsp/lib/common/GCC -l_soc_ns -l_wlan_mp_ns -Wl,--end-group
LIBFLAGS += -L../../../component/soc/realtek/8710c/misc/bsp/lib/common/GCC -l_dct_ns -l_eap_ns -l_http_ns -l_p2p_ns -l_websocket_ns -l_wps_ns
...
application_ns: prerequirement $(SRC_O) $(SRAM_O) $(ERAM_O) $(SRC_OO)
