...
/** @addtogroup  CENTRAL_CLIIENT_CALLBACK
    * @{
    */
T_CLIENT_ID   gcs_client_id;         /**< General Common Services client client id*/
...
T_APP_RESULT app_gap_callback(uint8_t cb_type, void *p_cb_data)
{
    ...
    case GAP_MSG_LE_SCAN_INFO:
        ...
        /* If you want to parse the scan info, please reference function app_parse_scan_info. */
