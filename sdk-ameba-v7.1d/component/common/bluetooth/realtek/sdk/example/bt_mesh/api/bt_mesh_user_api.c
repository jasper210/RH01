...
void bt_mesh_dfu_param_user_cmd(unsigned int argc, char **argv)
{
    ...
    if (strcmp((const char *)argv[1], (const char *)"?") == 0) {
        printf("[BT_MESH] ATBM=mesh_ota,dst,app_key_index,update_timeout_base \r\n");
    ...
    dfu_dist_start(dst, app_key_index, update_timeout_base, (uint8_t *)metadata_client, sizeof(metadata_client), 0, 
